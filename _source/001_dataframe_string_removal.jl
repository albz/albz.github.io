#md ---
#md layout: post
#md title: "Numerize me!"
#md date: 2019-01-01 00:00:00 +0000
#md categories: blog
#md mathjax: true
#md ---
...
# that for the given data-set is pretty pretty meanigless
# ![Julia corrplot](IMAGEFOLDER/001_dataframe_string_removal_01.png)



cd("C:\\Users\\a.marocchino\\Documents\\codes\\github.io")                                                                #src
using Literate                                                                                                            #src
...
IMAGEFOLDER = "_img\\001_dataframe_string_removal"                                                                        #src
Literate.notebook("_source\\001_dataframe_string_removal.jl", "notebooks", preprocess = setimagefolder)                   #src
# for Markdown/Jekyll notebook, put images in "/images"                                                                   #src
IMAGEFOLDER = "/_img/001_dataframe_string_removal"                                                                         #src
Literate.markdown("_source\\001_dataframe_string_removal.jl", ".", name="_posts\\dataframe_string_removal",               #src
